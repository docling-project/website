...
Importantly, the performance gains did not come at the cost of retrieval quality. Using the **[ViDoRe v3](https://huggingface.co/collections/vidore/vidore-benchmark-v3) benchmark**, which [evaluates](https://github.com/NVIDIA/NeMo-Retriever/blob/main/evaluation/bo767_recall.ipynb) downstream retrieval performance with the **NDCG@10** metric, Nemotron OCR maintained or improved accuracy across all evaluated domains. In some cases the gains were substantial, including improvements in the **Finance-FR** and **Energy** domains.
