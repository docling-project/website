...
CONTINUUM: list[Stage] = [
    ...
    Stage(
        ...
        index="03",
        name="Managed SaaS",
        goal="Add elastic capacity and managed operations.",
        experience="Hosted API with usage controls, observability and support.",
        cta_label="Scale this workflow",
        cta_href="/deployments/#saas",
    ...
    Stage(
        ...
        goal="Meet security, residency and infrastructure requirements.",
        experience="Private cloud, data centre or air-gapped deployment with the same API.",
        cta_label="Deploy privately",
        cta_href="/deployments/#on-prem",
        code="client = DoclingClient(base_url='https://docling.corp.internal')\nresult = client.convert(source)",
    ),
]
